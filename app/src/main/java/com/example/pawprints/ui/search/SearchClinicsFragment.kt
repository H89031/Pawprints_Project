 ...
 * Use the [SearchClinicsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SearchClinicsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_search_clinics, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SearchClinicsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SearchClinicsFragment().apply {
