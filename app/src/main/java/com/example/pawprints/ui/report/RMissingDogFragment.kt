 ...
 * Use the [RMissingDogFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RMissingDogFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_r_missing_dog, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RMissingDogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RMissingDogFragment().apply {
